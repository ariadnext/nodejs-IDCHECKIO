...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new idcheckio_nodejs_client.EventDate();
  });
  ...
  describe('EventDate', function() {
    it('should create an instance of EventDate', function() {
      // uncomment below and update the code to test EventDate
      //var instane = new idcheckio_nodejs_client.EventDate();
      //expect(instance).to.be.a(idcheckio_nodejs_client.EventDate);
    });
