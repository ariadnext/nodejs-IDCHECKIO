...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new idcheckio_nodejs_client.UserResponse();
  });
  ...
  describe('UserResponse', function() {
    it('should create an instance of UserResponse', function() {
      ...
      //var instane = new idcheckio_nodejs_client.UserResponse();
      //expect(instance).to.be.a(idcheckio_nodejs_client.UserResponse);
    });
