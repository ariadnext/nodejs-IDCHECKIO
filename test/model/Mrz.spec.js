...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new idcheckio_nodejs_client.Mrz();
  });
  ...
  describe('Mrz', function() {
    it('should create an instance of Mrz', function() {
      // uncomment below and update the code to test Mrz
      //var instane = new idcheckio_nodejs_client.Mrz();
      //expect(instance).to.be.a(idcheckio_nodejs_client.Mrz);
    });
