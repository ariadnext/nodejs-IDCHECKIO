...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new idcheckio_nodejs_client.MrzRequest();
  });
  ...
  describe('MrzRequest', function() {
    it('should create an instance of MrzRequest', function() {
      // uncomment below and update the code to test MrzRequest
      //var instane = new idcheckio_nodejs_client.MrzRequest();
      //expect(instance).to.be.a(idcheckio_nodejs_client.MrzRequest);
    });
