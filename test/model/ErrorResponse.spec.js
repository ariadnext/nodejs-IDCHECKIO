...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new idcheckio_nodejs_client.ErrorResponse();
  });
  ...
  describe('ErrorResponse', function() {
    it('should create an instance of ErrorResponse', function() {
      ...
      //var instane = new idcheckio_nodejs_client.ErrorResponse();
      //expect(instance).to.be.a(idcheckio_nodejs_client.ErrorResponse);
    });
