...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.idcheckio_nodejs_client.ApiClient = factory(root.superagent);
  }
  ...
  var exports = function() {
     ...
     */
    this.basePath = 'https://localhost/rest'.replace(/\/+$/, '');
  ...
  exports.prototype.callApi = function callApi(path, httpMethod, pathParams,
    ...
    request.redirects(0).end(function(error, response) {
      if (callback) {
        var data = null;
